<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master" CodeBehind="MantenedorProducto.aspx.vb" Inherits="DSI.MantenedorProducto" %>

<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    MANTENEDOR PRODUCTOS<br />
    insertar producto
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        DataKeyNames="ID_PRODUCTO" DataSourceID="SqlDataSource1">
        <Columns>
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" 
                        CommandName="Select" onclick="editar" Text="Editar"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" 
                        CommandName="Select" onclick="borrar" Text="Eliminar"></asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    </asp:GridView>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT SC_PRODUCTO.ID_PRODUCTO, SC_PRODUCTO.NOMBRE, SC_PRODUCTO.DESCRIPCION, SC_PRODUCTO.VALOR, SC_PRODUCTO_ASERRABLE.DIAMETRO, SC_PRODUCTO_ASERRABLE.LARGO, SC_PRODUCTO_PULPABLE.VOLUMEN 
FROM (SC_PRODUCTO left join SC_PRODUCTO_ASERRABLE ON SC_PRODUCTO.ID_PRODUCTO = SC_PRODUCTO_ASERRABLE.ID_PRODUCTO) left join SC_PRODUCTO_PULPABLE ON SC_PRODUCTO.ID_PRODUCTO = SC_PRODUCTO_PULPABLE.ID_PRODUCTO"></asp:SqlDataSource>
    ...
    <asp:Button ID="Button1" runat="server" Text="Editar" Visible="False" />
    <asp:Button ID="Button2" runat="server" Text="Cancelar" Visible="False" />
    <br />
    <asp:Button ID="Button3" runat="server" Text="Borrar" Visible="False" />
    <asp:Button ID="Button5" runat="server" Text="Cancelar" Visible="False" />
    <br />
</asp:Content>
