<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master"
    CodeBehind="MenuContratoClausula.aspx.vb" Inherits="DSI.MenuContratoClausula" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="TituloPagina">
        <h1>
            Creando contrato - Agregar Cláusulasa a Contrato</h1>
    </div>
    <h2>
        Paso 3 : Agregue las cláusulas que desee al contrato, haciendo click en "Seleccionar".</h2>
    <h2>
        Cláusulas a Agregar</h2>
    <h3>
        <asp:Label ID="LabelMensaje" runat="server" Text=""></asp:Label></h3>
    <div class="datagrid">
        <asp:GridView ID="GridViewClausula" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            DataKeyNames="ID_CLAUSULA" DataSourceID="SqlDataSourceClausula">
            <Columns>
                <asp:BoundField DataField="ID_CLAUSULA" HeaderText="ID_CLAUSULA" ReadOnly="True"
                    SortExpression="ID_CLAUSULA" />
    ...
    <asp:SqlDataSource ID="SqlDataSourceClausula" runat="server" ConnectionString="<%$ ConnectionStrings:connectionStringDSI %>"
        ProviderName="<%$ ConnectionStrings:connectionStringDSI.ProviderName %>" SelectCommand="SELECT &quot;ID_CLAUSULA&quot;, &quot;TITULO&quot;, &quot;DESCRIPCION&quot; FROM &quot;SC_CLAUSULA&quot; ORDER BY &quot;TITULO&quot;">
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourceMenuContratoClausula" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringDSI %>"
    ...
    <h2>
        Cláusulas asociadas al nuevo contrato</h2>
    <div class="datagrid">
        <asp:GridView ID="GridViewClausulasDelContrato" runat="server" AllowPaging="True"
            AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="ID_CONTRATO,ID_CLAUSULA"
            DataSourceID="SqlDataSourceClausulasDelContrato">
            <Columns>
                <asp:BoundField DataField="ID_CONTRATO" HeaderText="ID_CONTRATO" ReadOnly="True"
    ...
    <asp:SqlDataSource ID="SqlDataSourceClausulasDelContrato" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringDSI %>"
        ...
        ProviderName="<%$ ConnectionStrings:ConnectionStringDSI.ProviderName %>" SelectCommand="SELECT * FROM &quot;SC_CONTRATO_CLAUSULA&quot; WHERE (&quot;ID_CONTRATO&quot; = :ID_CONTRATO)">
        <DeleteParameters>
            <asp:Parameter Name="ID_CONTRATO" Type="Decimal" />
