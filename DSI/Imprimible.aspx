...
&nbsp;<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSourceContrato" runat="server" 
            ...
            SelectCommand="SELECT SC_CONTRATO.ID_CONTRATO, SC_CONTRATO.FC_CREACION, SC_CONTRATO.FC_INICIO, SC_CONTRATO.FC_TERMINO, SC_CONTRATO.VALOR_TOTAL, SC_CONTRATO.RUT, SC_CONTRATO.U_ORIGEN, SC_CONTRATO.U_DESTINO, SC_TIPO_CONTRATO.NOMBRE, SC_CLIENTE.RUT AS EXPR1, SC_CLIENTE.NOMBRE AS EXPR2, SC_CLIENTE.DIRECCION, SC_CLIENTE.COMUNA, SC_CLIENTE.CIUDAD, SC_CLIENTE.TELEFONO, SC_CLIENTE.ESTADO, SC_CLIENTE.EMAIL, SC_CLIENTE.ROWID FROM SC_CONTRATO, SC_TIPO_CONTRATO, SC_CLIENTE_CONTRATO, SC_CLIENTE WHERE SC_CONTRATO.ID_TIPO_CONTRATO = SC_TIPO_CONTRATO.ID_TIPO_CONTRATO AND SC_CONTRATO.ID_CONTRATO = SC_CLIENTE_CONTRATO.ID_CONTRATO AND SC_CLIENTE_CONTRATO.RUT = SC_CLIENTE.RUT AND (SC_CONTRATO.ID_CONTRATO = :ID_CONTRATO)">
            <SelectParameters>
