<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master"
    CodeBehind="MenuCumplimiento.aspx.vb" Inherits="DSI.MenuCumplimiento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" Text="CUMPLIMIENTO DE LOS CONTRATOS VIGENTES"></asp:Label>
    </p>
    <p>
    ...
    <p>
        <asp:Label ID="Label1" runat="server" Text="Label" Visible="False" Font-Bold="True"
            Font-Size="Larger"></asp:Label>
    </p>
    <p>
        <div class="datagrid">
            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSourceDetalle"
            CellPadding="4" ForeColor="#333333" GridLines="None" Width="829px">
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                ...
                <asp:BoundField DataField="CANTIDADGUIA" HeaderText="CANTIDAD ENTREGADA" SortExpression="CANTIDADGUIA" />
                <asp:BoundField DataField="CANTIDADCONTRATO" HeaderText="CANTIDAD CONTRATADO" SortExpression="CANTIDADCONTRATO" />
                <asp:BoundField DataField="VALOR" HeaderText="VALOR UNITARIO" SortExpression="VALOR" />
                <asp:BoundField DataField="PROCENTAJE" HeaderText="CUMPLIMIENTO %" SortExpression="PROCENTAJE" />
            </Columns>
            <EditRowStyle BackColor="#7C6F57" />
            <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
