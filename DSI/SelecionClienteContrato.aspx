<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master"
    CodeBehind="SelecionClienteContrato.aspx.vb" Inherits="DSI.SelecionClienteContrato" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="TituloPagina">
        <h1>
            Crear un contrato</h1>
            
    </div>
    <h2>Paso 1 : Por favor seleccione un cliente para inciar la creacion de contratos</h2>
    <br />
    <div class="datagrid">
        <asp:GridView ID="GridViewClienteParaContrato" runat="server" AllowPaging="True"
            AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="RUT" DataSourceID="SqlDataSourceClienteParaContrato">
            <Columns>
    ...
    <asp:SqlDataSource ID="SqlDataSourceClienteParaContrato" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringDSI%>"
