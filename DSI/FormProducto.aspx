<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master"
    CodeBehind="FormProducto.aspx.vb" Inherits="DSI.FormProducto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2>
        Complete los campos para crear un nuevo producto</h2>
    <asp:FormView ID="FormViewProducto" runat="server" DataKeyNames="ID_PRODUCTO" DataSourceID="SqlDataSourceProducto">
        ...
        <InsertItemTemplate>
            ...
            <br />
            DESCRIPCION:
            <asp:TextBox ID="DESCRIPCIONTextBox0" runat="server" Text='<%# Bind("DESCRIPCION") %>' />
            <br />
            VALOR:
    ...
    <asp:FormView ID="FormViewProductoAserrable" runat="server" DataKeyNames="ID_PRODUCTO"
        ...
        <InsertItemTemplate>
            DIAMETRO:
            <asp:TextBox ID="DIAMETROTextBox0" runat="server" Text='<%# Bind("DIAMETRO") %>' />
            <br />
            LARGO:
        ...
        <ItemTemplate>
            ID_PRODUCTO:
            <asp:Label ID="ID_PRODUCTOLabel2" runat="server" Text='<%# Eval("ID_PRODUCTO") %>' />
            <br />
            DIAMETRO:
    ...
    <asp:FormView ID="FormViewProductoPulpable" runat="server" DataKeyNames="ID_PRODUCTO"
        ...
        <InsertItemTemplate>
            VOLUMEN:
            <asp:TextBox ID="VOLUMENTextBox0" runat="server" Text='<%# Bind("VOLUMEN") %>' />
            <br />
        </InsertItemTemplate>
        <ItemTemplate>
            ID_PRODUCTO:
            <asp:Label ID="ID_PRODUCTOLabel3" runat="server" Text='<%# Eval("ID_PRODUCTO") %>' />
            <br />
            VOLUMEN:
    ...
    <asp:Button ID="Button6" runat="server" CssClass="botones" Text="Insertar" />
    <asp:Button ID="Button7" runat="server" CssClass="botones" Text="Cancelar" />
    <asp:SqlDataSource ID="SqlDataSourceMax" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionStringDSI %>"
        ProviderName="<%$ ConnectionStrings:ConnectionStringDSI.ProviderName %>" SelectCommand="SELECT MAX(ID_PRODUCTO) AS EXPR1 FROM SC_PRODUCTO">
    </asp:SqlDataSource>
</asp:Content>
