<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Global.Master" CodeBehind="FormAnexo.aspx.vb" Inherits="DSI.FormAnexo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:Label ID="LabelMensajes" runat="server" Text="Label"></asp:Label>
    <br />
    <asp:FormView ID="FormViewAnexo" runat="server" DataKeyNames="ID_ANEXO" 
        ...
        <InsertItemTemplate>
            ID_ANEXO:
            <asp:TextBox ID="ID_ANEXOTextBox" runat="server" 
                Text='<%# Bind("ID_ANEXO") %>' />
            <br />
            TITULO:
            <asp:TextBox ID="TITULOTextBox" runat="server" Text='<%# Bind("TITULO") %>' />
    ...
    <asp:SqlDataSource ID="SqlDataSourceAnexo" runat="server" 
        ...
        SelectCommand="SELECT * FROM &quot;SC_ANEXO&quot; WHERE (&quot;ID_ANEXO&quot; = :ID_ANEXO)" 
